...
const Notification = () => {
  ...
  return (
    <motion.div
      ...
      <div className={`absolute right-5 md:right-48 top-14 border-1 dark:border-${currentColor} rounded-lg dark:bg-secondary-dark-bg dark:text-gray-200 bg-white dark:[#484B52] transition-all w-96`} >
        <div className="flex justify-between items-center p-4 ml-4">
          <p className='font-semibold text-xl'>Notification  <em><sup>4 new</sup></em></p>
          <button
            type='button'
